...
namespace MonoCustomResourceRegistry {
    ...
    public class Plugin : EditorPlugin {
        ...
        readonly List<string> customTypes = new List<string>();
        ...
        void AddRegisteredType(Type type, string defaultBaseTypeName, File file) {
        ...
        static string FindClassPath(Type type) {
        ...
        static string FindClassPathNamespace(Type type) {
        ...
        static string FindClassPathRecursive(Type type) {
        ...
        static string FindClassPathRecursiveHelper(Type type, string directory) {
        ...
        static IEnumerable<Type> GetCustomRegisteredTypes() {
        ...
        void UnregisterCustomClasses() {
            foreach (string script in customTypes) {
